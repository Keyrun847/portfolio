                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">kiranveer256@gmail.com</span>

                            <a href="mailto:kiranveer256@gmail.com" className="contact__button">Write me&nbsp;<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+919663358955</span>

                            <a href="https://wa.me/919663358955?text=Hi%20Kiran" className="contact__button">Write me&nbsp;<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <a href="tel:+919663358955" className="contact__button">Call me&nbsp;<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                    </div>
                </div>
